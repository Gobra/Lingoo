...
{
    borderWidth = 2.0;
    [self setBorderColor:[NSColor colorWithCalibratedWhite:0.65 alpha:0.35]];
    [self setTitleColor:[NSColor whiteColor]];
    [self setBackgroundColor:[NSColor colorWithCalibratedWhite:0.50 alpha:0.1]];
    [self setTitleFont:[NSFont systemFontOfSize:[NSFont systemFontSizeForControlSize:NSSmallControlSize]]];
